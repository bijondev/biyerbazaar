...
class Mega_Menu_Walker extends Walker_Nav_Menu {
    ...
    function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $output .= "\n$indent<div class=\"sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners\">\n";
    }
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $output .= "<li class='current relative f_xs_none m_xs_bottom_5 {$class}' id='{$id}'>";
